 ...
 * @author Giovanni
 */
public class VwJIFStatusProjetoProjetista extends javax.swing.JInternalFrame {
    ...
    public VwJIFStatusProjetoProjetista(String cod) {
    ...
    public ArrayList<Projeto> projetoList(){
        ...
        try{
            ...
            String sql="SELECT * FROM private.status \n" +
                        "WHERE cod_funcional=" + cod_funcional + ";";
    ...
    private void initComponents() {
        ...
        if (jt_StatusProjetoProjetista.getColumnModel().getColumnCount() > 0) {
            jt_StatusProjetoProjetista.getColumnModel().getColumn(0).setPreferredWidth(5);
            jt_StatusProjetoProjetista.getColumnModel().getColumn(1).setPreferredWidth(200);
            jt_StatusProjetoProjetista.getColumnModel().getColumn(2).setPreferredWidth(40);
        }
